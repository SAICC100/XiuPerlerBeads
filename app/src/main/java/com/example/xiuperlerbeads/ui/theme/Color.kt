package com.example.xiuperlerbeads.ui.theme

import androidx.compose.ui.graphics.Color

// Brand colors
val MARDPrimary = Color(0xFFE91E63)      // Pink
val COCOPrimary = Color(0xFF9C27B0)      // Purple
val MANMANPrimary = Color(0xFF2196F3)   // Blue
val KAKAPrimary = Color(0xFF4CAF50)      // Green
val PANPANPrimary = Color(0xFFFF9800)   // Orange
val MIXIAOWOPrimary = Color(0xFF00BCD4) // Cyan

// Stock status colors
val StockEnough = Color(0xFF4CAF50)    // Green - sufficient stock
val StockLow = Color(0xFFFF9800)       // Orange - low stock
val StockOut = Color(0xFFF44336)       // Red - out of stock
